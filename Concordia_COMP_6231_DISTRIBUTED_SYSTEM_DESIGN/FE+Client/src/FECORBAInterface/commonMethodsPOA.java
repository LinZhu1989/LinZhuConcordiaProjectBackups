 ...
 */
public abstract class commonMethodsPOA extends org.omg.PortableServer.Servant
        implements commonMethodsOperations, org.omg.CORBA.portable.InvokeHandler
{
    public commonMethods _this()
    {
        return commonMethodsHelper.narrow(_this_object());
    }

    public commonMethods _this(org.omg.CORBA.ORB orb)
    {
        return commonMethodsHelper.narrow(_this_object(orb));
    }
