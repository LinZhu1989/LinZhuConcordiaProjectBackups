...
/*		System.out.println("Number of the integers to be sorted£º " + N);
		System.out.println("Number of sublists£º " + slices);
		System.out.println("Number of input buffers£º " + slices);
		System.out.println("Number of ouput buffers£º " + 1);
		System.out.println("Number of integers that a input buffer can hold£º " + inBufferSize);
		System.out.println("Number of integers that a output buffer can hold£º " + outBufferSize);
		*/
...
//			int bufUse = Integer.parseInt(bufferUsage);
			...
			System.out.println("Name of the file to be sorted£º " + fileName);
			System.out.println("Time of counting line numbers£º " + (readTime2 - readTime1) + " Msec");
	...
	public static void main(String[] args) throws IOException {
			...
			System.out.println("Total Execution Time£º " + (endTime - startTime) + "Msec");
	}
}